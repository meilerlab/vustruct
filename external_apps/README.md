...
At present, these scripts exist on the filesystem external to the corresponding rigid container.
This allows for more flexible debugging of the container<>VUstruct interface without
constantly regenerating containers
